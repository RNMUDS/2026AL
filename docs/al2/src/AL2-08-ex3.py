...
print("-" * 60)
print()
print("12都市の 39,916,800 通りに約9秒かかったので、1秒あたり約460万通り調べている。")
print("同じ速さだとすると、15都市の 87,178,291,200 通りには約5時間かかる。")
print("20都市（121,645,100,408,832,000 通り）なら、約800年かかる計算になる。")
