...
print(f"B: 中央を聞く       {max(binary_counts):>10}回 {sum(binary_counts)/len(binary_counts):>11.2f}回")
print("-" * 56)
print()
...
print("「1回の質問でいちばん多く候補を減らす」選び方が、中央を聞く作戦になっている。")
