...
{example_pair('AL2-04-ex1.py', '新宿から品川へは3通りの行き方があり、乗りかえ0回の直通が<strong>30分</strong>、'
...
{example_pair('AL2-04-ex2.py', '幅優先探索が選んだのは<strong>直通の30分</strong>の経路でした。'
...
{setup_guide('04', ['AL2-04-ex1.py', 'AL2-04-ex2.py'])}
