...
<header class="hero">
  <div class="container">
    ...
    <h1>採点ガイド</h1>
    <p>毎回100点＝標準課題70点（スライド1枚）＋発展課題30点（アプリ作品の今回の到達点）。どう見て、どう点を付けるか。標準課題は1クラスあたり5〜10分で終わる手順にしてある。</p>
  </div>
</header>
...
<section id="sec-flow">
  <div class="container">
    ...
    <div class="step-card">
      <h4>Step 3: 点を付ける</h4>
      <ul>
        <li>○ 70点／△ 30点／未提出 0点。締切（次回授業の開始時刻）後の提出は△まで、次回授業日以降は0点</li>
      </ul>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="step-card">
      ...
      <ul>
        ...
        <li>標準を全回○なら70点。S（90点以上）には発展の到達点を10回以上満たすことが必要</li>
      </ul>
      <table style="margin-top:0.8rem">
        <tr><th>例</th><th>標準</th><th>発展</th><th>平均</th></tr>
        <tr><td>毎回○、発展なし</td><td>70×15</td><td>0</td><td>70.0</td></tr>
        <tr><td>毎回○、発展10回</td><td>70×15</td><td>30×10</td><td>90.0</td></tr>
        <tr><td>毎回○、発展15回</td><td>70×15</td><td>30×15</td><td>100.0</td></tr>
        <tr><td>○12回・△3回、発展3回</td><td>70×12＋30×3</td><td>30×3</td><td>68.0</td></tr>
      </table>
    </div>
    ...
    <div class="step-card">
      <h4>欠席・遅れの扱い</h4>
      <ul>
        <li>標準課題の締切は次回授業の開始時刻。それを過ぎた提出は△（30点）まで、次回授業日以降は0点</li>
