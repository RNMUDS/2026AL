...
<section id="sec-flow">
  <div class="container">
    ...
    <div class="step-card">
      <h4>Step 1: PDFの最後の1枚を見て、その回の「課題要件」だけを確かめる</h4>
      <ul>
...
<section id="sec-flags">
  <div class="container">
    ...
    <div class="flag">
      ...
      共有URLから <strong>ファイル → 変更履歴 → 変更履歴を表示</strong>。何回ぶんかが同じ日に作られていれば、締切後にまとめて作っている。該当する回は減点。
    </div>
  ...
  <div class="container">
    ...
    <div class="step-card">
      ...
      <ul>
        ...
        <li>標準を全回満点なら70点。S（90点以上）には発展の到達点を10回以上満たすことが必要</li>
      </ul>
