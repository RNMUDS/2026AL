...
{fig_flow()}
    ...
    <div class="concept-box">
      ...
      <p style="font-size:0.95rem;margin-top:0.8rem">
        ...
        迷ったときは、この3つの問いを上から順に自分に投げかけてください。
      </p>
    </div>
...
{example(1, '巡回セールスマン問題を4つの方法で解く', ex1_body)}

{example(2, '大きさを変えて一括で測る', ex2_body)}"""

ans = answers([slide_example("11"), blank_answers("11"),
    ("確かめ用の数値", """        <p><strong>問い1</strong>: <strong>すべての辺の重みが同じとき</strong>に一致します。
        ...
        <p style="margin-top:0.8rem"><strong>例題2の数値（図に書き込むもの）</strong></p>
        <table>
