...
<section id="sec-about">
  <div class="container">
    ...
    <div class="info-grid">
      <div class="mini-card">
        <h5>評価方法</h5>
        <p>定期試験なし。<strong>毎回の課題提出で100%</strong>。毎回100点＝標準課題70点（Googleスライド: アルゴリズムの仕組みをコード上の変数や数値を用いて図で説明する）＋発展課題30点（アプリ作品を毎回の到達点に分けて育てる。任意）。成績は15回の平均。</p>
      </div>
      <div class="mini-card">
        <h5>使うもの</h5>
  ...
  <div class="container">
    ...
    <div class="diagram-container">
      <svg viewBox="0 0 700 200" width="700" xmlns="http://www.w3.org/2000/svg" font-family="Noto Sans JP, sans-serif" style="background:#0A0A0A">
        ...
        <text x="350" y="180" text-anchor="middle" fill="#FFB800" font-size="12" font-weight="700">前期は「探す」。後期は「数多くある選び方の中から、いちばん良い選び方を見つける」</text>
      </svg>
    </div>
