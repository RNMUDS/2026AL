...
def fig_five():
    ...
    s = [f'        <text x="350" y="26" text-anchor="middle" fill="{GREEN}" font-weight="700" font-size="15">'
         ...
         '全探索なら19の階乗＝約12京通り。まったく終わらない</text>']
...
{run('a15_ex1_result.png', '前半では、ダイクストラ法だけが<strong>27分</strong>の経路を見つけています。'
     ...
     '貪欲法だけが58.2と長くなっています。'
     'かかった時間は、全探索が0.08秒に対し bitDP は0.0016秒で、約50倍の差がつきました。'
...
{run('a15_ex4_result.png', '<strong>bitDP だけが最適の91.1</strong>を出し、6.214秒かかりました。'
